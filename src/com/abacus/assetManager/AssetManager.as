package com.abacus.assetManager {
	...
	public class AssetManager {
		...
		/** Returns a text file with a certain name. */
		...
		/** Register a text file under a certain name. It will be availble right away. */
		public function addText(name:String, text:String):void {

			log("Adding text file '" + name + "'");

			if(name in mText)
				throw new Error("Duplicate text name: " + name);
			else
				mText[name] = text;
		}
		...
		private function loadRawAsset(name:String, rawAsset:Object, xmls:Vector.<XML>, onProgress:Function, onComplete:Function):void {
