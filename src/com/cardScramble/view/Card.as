package com.cardScramble.view
{
	...
	public class Card extends Sprite
	{
		...
		public function selected():void{
			...
			TweenLite.to(this, 0.5, {scaleX:1.05, scaleY:1.05, ease:Expo.easeOut});
		...
		public function reveal(delay:Number):void{
			...
			_cardImage.scaleX = 0;
			TweenLite.to(_cardBack, 0.1, {delay:delay, x:_cardBack.x + _cardBack.width/2, scaleX:0, onComplete:onRevealComplete, onCompleteParams:[cardOrigX]});
		}
