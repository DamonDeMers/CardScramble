package com.cardScramble.utils
{
	...
	public class HandEvaluator
	{
			...
			for (var i:int = 0; i < len; i++) {
				...
				for (var j:int = 0; j < len2; j++) {
					...
					if(cardVO.value == cardVO2.value && cardVO != cardVO2){
						...
						_hands.push(handVO);
						trace("Test Hand: " + HandLookup.handToString(HandLookup.PAIR) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
						return handVO;
					} 
				}	
			}
				...
				for (var j:int = 0; j < cardsSelectedCopy.length; j++) {
					...
					if(cardVO.value == cardVO2.value && cardVO != cardVO2){
						...
						if(matchCount == 1){
							...
							cardsSelectedCopy.splice(cardsSelectedCopy.indexOf(cardVO2), 1);
						} else if (matchCount == 2){
							handVO.valid = true;
							handVO.hand = HandLookup.TWO_PAIR;
							_hands.push(handVO);
							trace("Test Hand: " + HandLookup.handToString(HandLookup.TWO_PAIR) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
		...
		private function threeOfAKind():HandVO{
			...
			for (var i:int = 0; i < len; i++) {
				...
				if(matchCount >= 2){
					...
					trace("Test Hand: " + HandLookup.handToString(HandLookup.THREE_OF_A_KIND) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
		...
		private function straight():HandVO{
			...
			_hands.push(handVO);
			trace("Test Hand: " + HandLookup.handToString(HandLookup.STRAIGHT) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
		...
		private function flush():HandVO{
			...
			_hands.push(handVO);
			trace("Test Hand: " + HandLookup.handToString(HandLookup.FLUSH) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
		...
		private function fullHouse():HandVO{
			...
			_hands.push(handVO);
			trace("Test Hand: " + HandLookup.handToString(HandLookup.FULL_HOUSE) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
		...
		private function fourOfAKind():HandVO{
			...
			_hands.push(handVO);
			trace("Test Hand: " + HandLookup.handToString(HandLookup.FOUR_OF_A_KIND) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
		...
		private function straightFlush():HandVO{
			...
			_hands.push(handVO);
			trace("Test Hand: " + HandLookup.handToString(HandLookup.STRAIGHT_FLUSH) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
		...
		private function royalFlush():HandVO{
			...
			if(straightFlush && _cardsSelected[_cardsSelected.length-1].value == "a"){
				handVO.valid = true;
				handVO.hand = HandLookup.ROYAL_FLUSH;
			}
			
			_hands.push(handVO);
			trace("Test Hand: " + HandLookup.handToString(HandLookup.ROYAL_FLUSH) + " ~~ Valid? " + handVO.valid + " ~~ Num Cards Stored " + handVO.cards.length);
